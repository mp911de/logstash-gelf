...
import biz.paluch.logging.gelf.GelfInboundHandler;
...
public class WildFlyIT {
    ...
    static class JmsQueueSetup implements ServerSetupTask {
        ...
        public void setup(ManagementClient managementClient, String containerId) throws Exception {
            ...
            commandContext
                    .handle("/subsystem=logging/root-logger=ROOT/:write-attribute(name=handlers,value=[\"FILE\",\"CONSOLE\",\"GelfLogger\"])");
        }
